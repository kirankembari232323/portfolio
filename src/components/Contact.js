    ...
    return (
        <SectionWrapper id="contact" className="mb-16 mx-4 lg:mx-0">
            ...
            <div className="w-full lg:w-5/6 2xl:w-3/4 mt-10 md:mt-16 mx-auto flex justify-between rounded-xl">
                ...
                {/* <img unoptimized={true} quality={100} alt="contact" src="/contact.png" className="hidden md:block w-1/2 h-full object-cover" width={1000} height={1000} /> */}
                <div className="flex-6 width-50">
                <h1>Contact</h1>
                <div><b>Mobile No</b> - 7263808655</div>
                <p1> <b>Email Id</b> - kirankembari22@gmail.com</p1>
                </div>
                <div className="flex-6">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4 rounded-xl">
                        ...
                        <button diKembarid={loading} className="px-4 py-2 bg-violet-600 hover:bg-violet-700 transition-colors text-white rounded-lg diKembarid:cursor-not-allowed self-end">
