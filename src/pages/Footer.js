            ...
            <div className="xl:max-w-6xl mx-auto md:mx-6 lg:mx-10 xl:mx-auto py-4 lg:py-6 flex flex-col-reverse md:flex-row gap-2 md:gap-0 justify-between items-center">
                ...
                <div className="hidden xl:flex items-center gap-2">
                    {/* <Link href={'https://nextjs.org'} target="_blank">
                        <img alt="Next.js" width={45} height={45} src="/nextjs.svg" className={`${'invert-0'} opacity-80 hover:opacity-100 transition-opacity`} />
                    </Link>
                    <p className="text-sm">X</p>
                    <Link href={'https://vercel.com'} target="_blank">
                        <img alt="Tailwind CSS" width={52} height={52} src="/vercel.svg" className={`${'invert-0'} opacity-80 hover:opacity-100 transition-opacity`} />
                    </Link> */}
                </div>
